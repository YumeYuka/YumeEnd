...
```html title="index.html" collapse={11-43} ins={"1":8-9} ins={"2":45-48} expandable icon="code"
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
```json title = "edgeone.json" expandable icon="code"
{
    "redirects": [
      {
        "source": "$host",
...
<Frame>
    <img src="https://s3.yumeyuka.plus/2025/09/caff028c6ffdf2f8739643e99854333e.webp"
         alt="Descriptive alt text"/>
</Frame>

<Frame>
    <img src="https://s3.yumeyuka.plus/2025/09/8f8889b95224d1163028a49f25455a73.webp"
         alt="Descriptive alt text"/>
</Frame>

<Frame>
    <img src="https://s3.yumeyuka.plus/2025/09/7d07df27da68d39948e7b374369afc65.webp"
         alt="Descriptive alt text"/>
</Frame>